...
import { ArrowLeft, MessageCircle, Heart, Trophy, Users } from "lucide-react"
        ...
        <section className="bg-white rounded-xl shadow-sm p-8 mb-6">
          ...
          <ul className="space-y-3">
            <li className="flex gap-3">
              ...
              <span className="text-gray-700">1つのお題に対して<span className="font-bold">最大3回まで</span>回答できます</span>
            </li>
            <li className="flex gap-3">
              <span className="text-yellow-500 font-bold">•</span>
              <span className="text-gray-700">ハートは1つのお題に対して<span className="font-bold">3つまで</span>送れます</span>
            </li>
            <li className="flex gap-3">
              <span className="text-yellow-500 font-bold">•</span>
              <span className="text-gray-700">自分の投稿にはハートを送れません</span>
            </li>
            <li className="flex gap-3">
              <span className="text-yellow-500 font-bold">•</span>
              <span className="text-gray-700">投稿した回答は削除できません（よく確認してから投稿しましょう）</span>
            </li>
            <li className="flex gap-3">
              <span className="text-yellow-500 font-bold">•</span>
              <span className="text-gray-700">他のユーザーを尊重し、楽しくコミュニケーションしましょう</span>
            </li>
          </ul>
        </section>
